    ...
    <div class="container-fluid tm-mt-60">
        <div class="row mb-4">
            <h2 class="col-12 tm-text-primary">
                About July Revolution 2024
            </h2>
        </div>
        <div class="row tm-mb-74 tm-row-1640">            
            <div class="col-lg-5 col-md-6 col-12 mb-3">
                <img src="<?=ASSETS?>catalog/img/about.jpeg" alt="Image" class="img-fluid">
            </div>
            <div class="col-lg-7 col-md-6 col-12">
                ...
                <p>  Welcome to July_revolution, a digital gallery dedicated to preserving the story of the July Revolution and its significance in our history. We aim to create a comprehensive, safe, and interactive platform where users can explore, contribute, and reflect on the events that shaped our nation.</p>
<br>

                <p>July_revolution was born from a desire to provide a unified space for historical documentation, combining news, personal narratives, and visual media that encapsulate the spirit of the July Revolution. Unlike typical platforms, our focus extends beyond sharing historical content—we emphasize accuracy, security, and user experience in handling sensitive topics.</p>

<br> 
                <p>Our project addresses the gaps found in existing platforms by introducing unique features, such as content warnings for sensitive information and two-factor authentication for contributor accounts, ensuring a trustworthy environment. We are committed to safeguarding historical integrity and promoting an inclusive platform where journalists, students, and citizens alike can share, view, and preserve these important narratives.</p>

<br>
                <p>### Mission<br>
<p>Our mission is to build a digital archive that accurately reflects the events and legacy of the July Revolution. We seek to preserve truth and provide a safe space for stories that deserve to be remembered and respected.</p>
<br>

<p>### Our Team</p>
<p>Our team comprises passionate individuals from diverse backgrounds, working collaboratively to bring this vision to life. Through dedicated efforts in front-end design, backend development, and content moderation, we strive to deliver a user-friendly experience that meets high standards of security, accessibility, and performance.</p>

<br>
<p>
Thank you for visiting July_revolution. Join us in preserving and exploring our history.</p>
